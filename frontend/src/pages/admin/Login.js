      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-xs text-blue-800 mb-1 font-semibold">First Time Setup:</p>
            <p className="text-xs text-blue-700">Create your admin account using the signup page or contact your system administrator.</p>
          </div>
